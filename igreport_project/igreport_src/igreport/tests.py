...
class ModelTest(TestCase):  # pragma: no cover
    ...
    def test_igreport(self):
        ...
        when = '7 days ago'
        name = 'david mcReporter'

        # fake report
        self.fake_incoming('corrupt', self.connection)
        ...
        self.fake_script_dialog(script_prog, [
            ('hotline_complaint', report),
            ('hotline_accused', accused), \
        ...
        self.assertEquals(ig_report.names, name)
        self.assertEquals(ig_report.connection.contact.name, name)
        self.assertEquals(ig_report.subject, accused)
        self.assertEquals(ig_report.amount_freeform, amount)
        self.assertEquals(ig_report.district, Location.objects.get(type__name='district', name__iexact='busia'))
    ...
    def test_keyword_correct(self):
        ...
        self.assertEquals(report.connection.contact.language, 'eng')
